...
import { showSuccess } from "./animation.js";

// For daughter
const UPPERCASE = true;
const highPoints = true;
  ...
  .then((data) => {
    ...
    function checkScore(words, score, category, correctWordCount) {
      ...
      if (score.every((e) => e === true)) {
        correctWordCount += 1;
        if (levelSelector.value === "EASY") {
          totalScore = highPoints ? totalScore + 3 : totalScore + 0.10001;
    ...
    function showNewWord(word, words, category, dataClone) {
      ...
      componentWords.forEach((word) => {
        ...
        lettersArray.forEach((letter) => {
          ...
          // letterInput.autocapitalize = "start";
          // letterInput.setAttribute("autocapitalize", "words");
    ...
    function markLetters(id, word, words, score, category, correctWordCount) {
      ...
      if (
        ...
        // letterInput[id].autocapitalize = "on";

        letterInput[id].classList.add("correct-letter");
        UPPERCASE && letterInput[id].classList.add("uppercase");
            ...
            if (event.key >= "A" && event.key <= "z") {
              ...
              function setFocus() {
                ...
                function getIndexOfIncorrectLetters() {
                  ...
                  if (
                    indexOfIncorrectLetters.length <
    ...
    function explode() {
      ...
      bar.style.left = "50%";
      bar.style.top = "50%";
      bar.style.transform = "-50%, -50%";
      bar.style.width = "800px";
